...
class ml_ad_widget extends WP_Widget {
  ...
  function widget($args, $instance) {
   ...
   echo $before_widget;
      ...
      if($random==0){
        if ($banner_code1) { echo $banner_code1; } else { echo '<a href="' . $banner_url1 . '" target="_blank"><img src="' . $banner_image1[0] . '" alt="" /></a>' . "\n"; };
      } elseif($random==1){
        if ($banner_code2) { echo $banner_code2; } else { echo '<a href="' . $banner_url2 . '" target="_blank"><img src="' . $banner_image2[0] . '" alt="" /></a>' . "\n"; };
      } elseif($random==2){
        if ($banner_code3) { echo $banner_code3; } else { echo '<a href="' . $banner_url3 . '" target="_blank"><img src="' . $banner_image3[0] . '" alt="" /></a>' . "\n"; };
      };
